...
import (
	...
	. "k8s-learn/apiserver/pkg/apis/learn/v1"
	. "k8s-learn/apiserver/pkg/client/clientset_generated/clientset/typed/learn/v1"
)

var _ = Describe("Nginx", func() {
	var instance Nginx
	var expected Nginx
	var client NginxInterface
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.LearnV1().Nginxes("nginx-test-valid")
