...
import (
	...
	. "k8s-learn/apiserver/pkg/apis/mycode/v1alpha1"
	. "k8s-learn/apiserver/pkg/client/clientset_generated/clientset/typed/mycode/v1alpha1"
)
	...
	Describe("when sending a storage request", func() {
		Context("for a valid config", func() {
			It("should provide CRUD access to the object", func() {
				client = cs.MycodeV1alpha1().MyControllers("mycontroller-test-valid")
