...
type FakeMyControllers struct {
	Fake *FakeMycodeV1alpha1
	ns   string
}

var mycontrollersResource = schema.GroupVersionResource{Group: "mycode.my.io", Version: "v1alpha1", Resource: "mycontrollers"}

var mycontrollersKind = schema.GroupVersionKind{Group: "mycode.my.io", Version: "v1alpha1", Kind: "MyController"}
...
func (c *FakeMyControllers) List(opts v1.ListOptions) (result *v1alpha1.MyControllerList, err error) {
	...
	list := &v1alpha1.MyControllerList{ListMeta: obj.(*v1alpha1.MyControllerList).ListMeta}
