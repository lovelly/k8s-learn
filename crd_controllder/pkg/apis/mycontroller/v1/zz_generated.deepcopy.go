...
func (in *MyStatus) DeepCopyInto(out *MyStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MyStatus.
func (in *MyStatus) DeepCopy() *MyStatus {
	if in == nil {
		return nil
	}
	out := new(MyStatus)
