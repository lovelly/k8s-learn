...
import (
	...
	versioned "k8s-learn/crd_controllder/pkg/client/clientset/versioned"
	internalinterfaces "k8s-learn/crd_controllder/pkg/client/informers/externalversions/internalinterfaces"
	v1 "k8s-learn/crd_controllder/pkg/client/listers/mycontroller/v1"
	time "time"
...
func (f *nginxInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&mycontrollerv1.Nginx{}, f.defaultInformer)
}
